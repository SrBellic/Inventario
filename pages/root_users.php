        ...
        <div class="collapse" id="navbarToggleExternalContent">
            <div class="d-flex justify-content-end text-end mx-5">
                <div class="navbar-nav bg-color-darkmagenta ps-5 pe-2 py-2 rounded-bottom">
                    <a href="root_stock.php" class="link-white me-1 mb-1 fs-5">Administración de Inventario<img src="../assets/favicons/system/trolley24x24.png" class="mx-1" alt="Inventario"></a>
